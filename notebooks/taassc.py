...
semantic_noun = open("TAASSC/dev_versions/TAASSC 2.1.x/lists_LGR/semantic_class_noun.txt").read().split("\n") #add notes for source. Biber et al. 2004?
semantic_verb = open("TAASSC/dev_versions/TAASSC 2.1.x/lists_LGR/semantic_class_verb.txt").read().split("\n") #add notes for source. Biber et al. 2004?
semantic_adj = open("TAASSC/dev_versions/TAASSC 2.1.x/lists_LGR/semantic_class_adj.txt").read().split("\n") #add notes for source. Biber et al. 2004?
semantic_adv = open("TAASSC/dev_versions/TAASSC 2.1.x/lists_LGR/semantic_class_adverb_5-25-20.txt").read().split("\n") #add notes for source. Biber et al. 2004?
nominal_stop = open("TAASSC/dev_versions/TAASSC 2.1.x/lists_LGR/nom_stop_list_edited.txt").read().split("\n") # created based on frequently occuring nouns with [potential] nominalizer suffixes in TMLE + T2KSWAL
...
index_list = open("TAASSC/dev_versions/TAASSC 2.1.x/lists_LGR/LGR_index_list_5-26-20.txt").read().split("\n")
